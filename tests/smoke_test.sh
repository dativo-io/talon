...
# - Sections: test_section_01_binary .. test_section_28_control_plane + test_consistency_checks.
...
#   26 pii-enrichment | 27 runtime-governance | 28 control-plane | consistency.
#
# QA notes (from brief):
