...
.PHONY: help build install test test-integration test-e2e test-smoke test-all test-ssot-gate conformance benchmarks benchmark-regression proof-gates auditor-pack verify-newcomer lint fmt clean vet mod-tidy check docker-build demo-gateway demo-full demo-clean verify-flow0 nosec-count
...
benchmark-regression: ## Enforce BenchmarkPIIScan <=10% vs baseline artifact
