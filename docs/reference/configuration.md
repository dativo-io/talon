...
- **Auth model:** See [Authentication and key scopes](authentication-and-key-scopes.md) for endpoint-to-key mapping (gateway caller keys vs control-plane API keys vs dashboard token).
